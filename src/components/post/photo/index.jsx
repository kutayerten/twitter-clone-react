...
export default function Photo({ photos }) {
  switch (photos.length){
    case 1:
      return(
        <div className='mt-3'>
            <img src={photos[0]} alt='' className='max-h[510px] object-cover border border-[color:var(--background-third)] rounded-2xl' />
        </div>
      )
        ...
        return(
            <div className='mt-3 grid grid-cols-2 gap-0.5 h-[288px] border border-[color:var(--background-third)] rounded-2xl overflow-hidden'>
                ...
                <div className='h-full flex flex-col gap-0.5'>
                    ...
                    <div className='flex-shrink-0 flex-1 relative'>
                        <img src={photos[0]} alt='' className='h-full absolute inset-0 flex-shrink-0 w-full object-cover ' />
                    </div>
                </div>
            </div>
          )
