  ...
  return (
    <footer className='mb-4 px-4 flex flex-wrap gap-2'>
        ...
        <Popover className="relative inline-flex leading-4">
            ...
            <Link to="/" className='py-3 px-4 text-white leading-5 text-[15px] font-bold transition-colors w-full hover:bg-[color:var(--background-secondary)]'>About</Link>
            <Link to="/" className='py-3 px-4 text-white leading-5 text-[15px] font-bold transition-colors w-full hover:bg-[color:var(--background-secondary)]'>Download the X app</Link>
            <Link to="/" className='py-3 px-4 text-white leading-5 text-[15px] font-bold transition-colors w-full hover:bg-[color:var(--background-secondary)]'>Status</Link>
            <Link to="/" className='py-3 px-4 text-white leading-5 text-[15px] font-bold transition-colors w-full hover:bg-[color:var(--background-secondary)]'>X for Business</Link>
            <Link to="/" className='py-3 px-4 text-white leading-5 text-[15px] font-bold transition-colors w-full hover:bg-[color:var(--background-secondary)]'>Developers</Link>
            </Popover.Panel>
        </Popover>
        </div>
        <span className='text-[color:var(--color-base-secondary)]   leading-4 text-[13px]'>© 2023 Kutay Erten.</span>
    </footer>
  )
}
