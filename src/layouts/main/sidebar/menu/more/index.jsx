    ...
    <Popover className="relative">
        ...
        <Popover.Panel className="w-[318px] absolute bottom-0 left-0 bg-black shadow-box rounded-xl overflow-hidden ">
            {/**Content here */}
               ...
               <button className="px-3 h-14 w-full  inline-flex  items-center gap-5  hover:bg-[#3c424452] transition-colors overflow-hidden" >
                   <div className="w-[24px] h-[24px] relative">
                  <svg viewBox="0 0 24 24" className="block" fill="#fff" width={24} height={24}><path d="M4 4.5C4 3.12 5.119 2 6.5 2h11C18.881 2 20 3.12 20 4.5v18.44l-8-5.71-8 5.71V4.5zM6.5 4c-.276 0-.5.22-.5.5v14.56l6-4.29 6 4.29V4.5c0-.28-.224-.5-.5-.5h-11z"/></svg>
                   </div>
               ...
               <Disclosure>
                   {({open}) => (
                    <>
                        <Disclosure.Button className="w-full  h-[52px] flex items-center justify-between px-4 font-bold hover:bg-[#3c424452] transition-colors">
                        Creator Studio 
                            <svg 
                        ...
                        <Disclosure.Panel className="text-white ">
                            <Link to="/" className="flex px-4 items-center h-11 gap-3 text-[15px] font-medium hover:bg-[#3c424452] transition-colors">
